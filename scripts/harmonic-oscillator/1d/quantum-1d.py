...
if __name__ == '__main__':
    ...
    problem = harmonicoscillator.HarmonicOscillatorVariableN(0, N_MAX, R_max, m, omega, training_parameters.weight, use_quantum_1d=True)
    ...
    storage.save_loss_plot('quantum-1d')
