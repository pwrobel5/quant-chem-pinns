...
if __name__ == '__main__':
    ...
    problem_x = linearwell.LinearWellVariableN(1, NX_MAX, LX, training_parameters.weight, training_parameters.is_random)
    problem_y = linearwell.LinearWellVariableN(1, NY_MAX, LY, training_parameters.weight, training_parameters.is_random)
    ...
    for nx in range(1, 8):
        for ny in range(1, 8):
            ...
            storage.save_to_csv('rectangular-generalised-n', csv_row)